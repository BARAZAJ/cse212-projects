...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: 
    //The test failed, it was expecting the name "Bob" but it received "Sue". 
    ...
    // Defect(s) Found: 
    //The test case failed. It expected the first name "Bob" but got "Sue" instead.
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: 
    //The test case failed, it expected "Bob" as the first name but got "sue".
    ...
    // Defect(s) Found: 
    //The test case failed. It expected the name "Tim" but got "Sue" instead
